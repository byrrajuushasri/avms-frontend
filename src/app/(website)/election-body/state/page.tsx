      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-10 border-b border-gray-200 pb-6">
          ...
          <p className="mt-3 max-w-3xl text-gray-600 leading-7">
            The State Body represents the organization at the state level.
            Members are responsible for coordinating activities, supporting
            district and local bodies, and contributing to the development of
            the community.
            The State Body represents the organization at the state level.
            Members are responsible for coordinating activities, supporting
            district and local bodies, and contributing to the development of
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                Add and register new members to the State Body.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                View and manage members currently associated with the State Body.
              </p>
            </div>
          </Link>
