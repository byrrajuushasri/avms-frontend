      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-10 border-b border-gray-200 pb-6">
          ...
          <p className="mt-3 max-w-3xl text-gray-600 leading-7">
            The mandal Body represents the organization at the district
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                Add and register new members to the mandal Body.
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-gray-500">
                View and manage members currently associated with the mandal
                Body.
              </p>
            </div>
          </Link>
